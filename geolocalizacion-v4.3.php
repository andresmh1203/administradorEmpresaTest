                    ...
                    <?php
                        ...
                        for($x=0;$x<$tamañoFilas;$x++){
                            echo "<tr>";
                                ...
                                echo "<td><a href='geolocalizacion-v4.3.php?rutId=" . $arreglo[$x]['ID'] . "'>e</td>";
                                echo "<td><a href='geolocalizacion-v4.3.php?rutId=" . $arreglo[$x]['ID'] . "&banderaEliminar=1'>x</td>";
                            echo "</tr>";
                        }
                        echo "</tbody>";
                    ?>
...
//******ACTUALIZAR RUTA**********
    ...
    <script id='google-maps'>
        ...
        document.getElementById('key-icono').addEventListener('click', function (){
            window.open ('panel-control-v4.3.php', '_self');
        });
